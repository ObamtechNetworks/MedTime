...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, first_name, last_name, password, **extra_fields):
        ...
        if email:
            ...
            self.email_validator(email)  # validate the provided email
        else:
        ...
        # set the password by hashing (using django set_password hashing mechanism)
    ...
    def create_superuser(self, email, first_name, last_name, password, **extra_fields):
        ...
        """
        # set default fields to true for super user
